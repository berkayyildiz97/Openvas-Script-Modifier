...
if(officeVer && officeVer =~ "^(9|1[0-2])\.")
{
  ...
  if(version_in_range(version:wordVer, test_version:"9.0", test_version2:"9.0.0.8978")){
    report = report_fixed_ver(installed_version:wordVer, fixed_version:"9.0.0.8979");
    security_message(data:report);
  }
  else if(version_in_range(version:wordVer, test_version:"10.0", test_version2:"10.0.6853.0")){
    report = report_fixed_ver(installed_version:wordVer, fixed_version:"9.0.0.897910.0.6853.1");
    security_message(data:report);
  }
  else if(version_in_range(version:wordVer, test_version:"11.0", test_version2:"11.0.8306.0")){
    report = report_fixed_ver(installed_version:wordVer, fixed_version:"9.0.0.897910.0.6853.111.0.8306.1");
    security_message(data:report);
  }
  else if(version_in_range(version:wordVer, test_version:"12.0", test_version2:"12.0.6504.4999")){
    report = report_fixed_ver(installed_version:wordVer, fixed_version:"9.0.0.897910.0.6853.111.0.8306.112.0.6504.5000");
    security_message(data:report);
  }
}
...
if(wordVer =~ "^12\.")
{
  ...
  if(version_in_range(version:wordcnvVer, test_version:"12.0", test_version2:"12.0.6500.4999")){
    report = report_fixed_ver(installed_version:wordcnvVer, fixed_version:"9.0.0.897910.0.6853.111.0.8306.112.0.6504.500012.0.6500.5000");
    security_message(data:report);
  }
}
...
if(wordviewVer)
{
  if(version_in_range(version:wordviewVer, test_version:"11.0", test_version2:"11.0.8306.0")){
    report = report_fixed_ver(installed_version:wordviewVer, fixed_version:"9.0.0.897910.0.6853.111.0.8306.112.0.6504.500012.0.6500.500011.0.8306.1");
    security_message(data:report);
  }
}
