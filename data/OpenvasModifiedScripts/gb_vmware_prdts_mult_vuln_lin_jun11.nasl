...
if(vmpVer)
{
  ...
  {
    report = report_fixed_ver(installed_version:vmpVer, fixed_version:"3.1.4");
...
if(vmwtnVer)
{
  if(version_in_range(version:vmwtnVer, test_version:"7.1.0", test_version2:"7.1.3")){
    report = report_fixed_ver(installed_version:vmwtnVer, fixed_version:"3.1.47.1.4");
    security_message(data:report);
  }
}
...
if(vmesx)
{
  if(version_in_range(version:vmesx, test_version:"3.0.3", test_version2:"4.1.0")){
    report = report_fixed_ver(installed_version:vmesx, fixed_version:"3.1.47.1.44.1.1");
    security_message(data:report);
  }
}
