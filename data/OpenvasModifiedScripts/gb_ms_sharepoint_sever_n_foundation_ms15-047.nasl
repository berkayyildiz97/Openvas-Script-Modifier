...
if(shareVer =~ "^12\..*")
{
  ...
  if(path)
  {
    ...
    if(dllVer)
    {
      ...
      {
        report = report_fixed_ver(installed_version:dllVer, fixed_version:"12.0.6721.5000", install_path:path);
...
if(shareVer =~ "^14\..*")
{
  ...
  if(path)
  {
    ...
    if(dllVer)
    {
      ...
      {
        report = report_fixed_ver(installed_version:dllVer, fixed_version:"12.0.6721.500014.0.7149.5000", install_path:path);
        security_message(data:report);
        exit(0);
      }
    }
...
if(shareVer =~ "^15\..*")
{
  ...
  if(path)
  {
    ...
    if(dllVer)
    {
      ...
      {
        report = report_fixed_ver(installed_version:dllVer, fixed_version:"12.0.6721.500014.0.7149.500015.0.4719.1000", install_path:path);
        security_message(data:report);
        exit(0);
      }
    }
