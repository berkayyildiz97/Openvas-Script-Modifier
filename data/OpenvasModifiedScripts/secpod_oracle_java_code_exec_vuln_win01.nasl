...
if(jreVer)
{
  ...
  {
    report = report_fixed_ver(installed_version:jreVer, fixed_version:"1.6.0.24");
...
if(jdkVer)
{
  if(version_in_range(version:jdkVer, test_version:"1.6.0.21", test_version2:"1.6.0.23")){
     report = report_fixed_ver(installed_version:jdkVer, fixed_version:"1.6.0.241.6.0.24");
     security_message(data:report);
     exit(0);
  }
}
