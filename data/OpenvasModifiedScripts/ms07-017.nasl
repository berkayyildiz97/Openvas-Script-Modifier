...
if(hotfix_check_sp(win2k:5) > 0 && vers)
{
  ...
  if("Service Pack 4" >< SP)
  {
    if(version_in_range(version:vers, test_version:"5.0", test_version2:"5.0.2195.7133")){
      report = report_fixed_ver(installed_version:vers, fixed_version:"5.0.2195.7134", install_path:dllPath);
...
else if(hotfix_check_sp(xp:4) > 0 && vers)
{
  ...
  if("Service Pack 2" >< SP)
  {
    if(version_in_range(version:vers, test_version:"5.1", test_version2:"5.1.2600.3099")){
      report = report_fixed_ver(installed_version:vers, fixed_version:"5.0.2195.71345.1.2600.3100", install_path:dllPath);
      security_message(data:report);
    }
  }
}
...
else if(hotfix_check_sp(win2003:3) > 0 && vers)
{
  ...
  if("Service Pack 1" >< SP)
  {
    if(version_in_range(version:vers, test_version:"5.2", test_version2:"5.2.3790.2892")){
      report = report_fixed_ver(installed_version:vers, fixed_version:"5.0.2195.71345.1.2600.31005.2.3790.2893", install_path:dllPath);
      security_message(data:report);
    }
  }
  else if("Service Pack 2" >< SP)
  {
    ...
    if(version_in_range(version:vers, test_version:"5.2", test_version2:"5.2.3790.4033")){
      report = report_fixed_ver(installed_version:vers, fixed_version:"5.0.2195.71345.1.2600.31005.2.3790.28935.2.3790.4034", install_path:dllPath);
      security_message(data:report);
    }
  }
  else if("Service Pack 0">< SP){
	if(version_in_range(version:vers, test_version:"5.2", test_version2:"5.2.3790.651")){
      report = report_fixed_ver(installed_version:vers, fixed_version:"5.0.2195.71345.1.2600.31005.2.3790.28935.2.3790.40345.2.3790.652", install_path:dllPath);
      security_message(data:report);
    }
  }
}
...
else if(hotfix_check_sp(vista:2) > 0 && vers2)
{
  ...
  if("Service Pack 0" >< SP)
  {
    if(version_in_range(version:vers2, test_version:"6.0", test_version2:"6.0.6000.16438")){
      report = report_fixed_ver(installed_version:vers2, fixed_version:"5.0.2195.71345.1.2600.31005.2.3790.28935.2.3790.40345.2.3790.6526.0.6000.16439", install_path:dllPath);
      security_message(data:report);
    }
  }
}
