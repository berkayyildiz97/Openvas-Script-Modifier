...
if(jdkVer)
{
  ...
  {
    report = report_fixed_ver(installed_version:jdkVer, fixed_version:"1.6.0.22");
...
if(jreVer)
{
  if(version_in_range(version:jreVer, test_version:"1.6", test_version2:"1.6.0.21")) {
    report = report_fixed_ver(installed_version:jreVer, fixed_version:"1.6.0.221.6.0.22");
    security_message(data:report);
  }
}
