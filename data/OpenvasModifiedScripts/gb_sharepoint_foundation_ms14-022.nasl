...
if(shareVer =~ "^14\.")
{
  ...
  if(dllVer)
  {
    ...
    {
      report = report_fixed_ver(installed_version:dllVer, fixed_version:"14.0.7123.5000", install_path:path);
...
if(shareVer =~ "^15\.")
{
  ...
  if(path)
  {
    ...
    if(dllVer2)
    {
      ...
      {
        report = report_fixed_ver(installed_version:dllVer2, fixed_version:"14.0.7123.500015.0.4615.1000", install_path:path);
        security_message(data:report);
        exit(0);
      }
    }
