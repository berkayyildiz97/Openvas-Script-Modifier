...
if(shareVer =~ "^14\..*")
{
  ...
  if(dllVer)
  {
    ...
    {
      report = report_fixed_ver(installed_version:dllVer, fixed_version:"14.0.7010.1000", install_path:path);
...
if(shareVer =~ "^15\..*")
{
  ...
  if(dllVer)
  {
    ...
    {
      report = report_fixed_ver(installed_version:dllVer, fixed_version:"14.0.7010.100015.0.4525.1000", install_path:path);
      security_message(data:report);
      exit(0);
    }
  }
