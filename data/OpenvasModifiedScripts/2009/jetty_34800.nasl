...
if( version_is_less_equal( version: version, test_version: "5.1.14" ) ) {
  ...
  report = report_fixed_ver(installed_version:version, vulnerable_range:"Less than or equal to 5.1.14");
...
if( version_in_range( version: version, test_version: "6.0.0", test_version2: "6.1.16" ) ) {
  ...
  report = report_fixed_ver(installed_version:version, vulnerable_range:"6.0.0 - 6.1.16");
  security_message(port: port, data: report);
  exit( 0 );
}
...
if( version_in_range( version: version, test_version: "7.0.0", test_version2: "7.0.0.M2" ) ) {
  ...
  report = report_fixed_ver(installed_version:version, vulnerable_range:"7.0.0 - 7.0.0.M2");
  security_message(port: port, data: report);
  exit( 0 );
}
