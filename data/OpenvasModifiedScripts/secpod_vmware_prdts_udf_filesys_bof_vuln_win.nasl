...
if(vmplayerVer != NULL )
{
  ...
  {
    report = report_fixed_ver(installed_version:vmplayerVer, fixed_version:"3.1.5");
...
if(vmworkstnVer != NULL)
{
  if(version_in_range(version:vmworkstnVer, test_version:"7.0", test_version2:"7.1.4")){
      report = report_fixed_ver(installed_version:vmworkstnVer, fixed_version:"3.1.57.1.5");
      security_message(data:report);
  }
}
