...
if(vmplayerVer != NULL )
{
  ...
  {
    report = report_fixed_ver(installed_version:vmplayerVer, fixed_version:"2.5.4");
...
if(vmworkstnVer != NULL)
{
  ...
  {
    report = report_fixed_ver(installed_version:vmworkstnVer, fixed_version:"2.5.46.5.4");
    security_message(data:report);
    exit(0);
  }
}
...
if(!aceVer)
{
  ...
  if(aceVer)
  {
    if(version_in_range(version:aceVer, test_version:"2.5", test_version2:"2.5.3")){
      report = report_fixed_ver(installed_version:aceVer, fixed_version:"2.5.46.5.42.5.4");
      security_message(data:report);
    }
  }
}
...
if(vmserVer)
{
  if(version_in_range(version:vmserVer, test_version:"2.0", test_version2:"2.0.1")){
    report = report_fixed_ver(installed_version:vmserVer, fixed_version:"2.5.46.5.42.5.42.0.2");
    security_message(data:report);
  }
}
