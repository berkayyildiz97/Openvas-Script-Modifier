...
dllPath = sysPath + "\mshtml.dll";
 ...
 if(dllVer)
 {
   if(hotfix_check_sp(winVista:2) > 0)
   {
     ...
     if("Service Pack 1" >< SP)
     {
       if(version_in_range(version:dllVer, test_version:"7.0", test_version2:"7.0.6001.18098")){
          report = report_fixed_ver(installed_version:dllVer, fixed_version:"7.0.6001.18099", install_path:sysPath);
   ...
   else if(hotfix_check_sp(win2008:2) > 0)
   {
     ...
     {
       if(version_in_range(version:dllVer, test_version:"7.0", test_version2:"7.0.6001.18098")){
          report = report_fixed_ver(installed_version:dllVer, fixed_version:"7.0.6001.180997.0.6001.18099", install_path:sysPath);
          security_message(data:report);
       }
         exit(0);
     }
