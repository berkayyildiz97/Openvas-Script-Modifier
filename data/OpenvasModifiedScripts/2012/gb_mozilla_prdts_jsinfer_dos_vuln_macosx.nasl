...
if(ffVer)
{
  ...
  {
    report = report_fixed_ver(installed_version:ffVer, vulnerable_range:"10.0 - 10.0.4");
...
if(tbVer)
{
  ...
  {
    report = report_fixed_ver(installed_version:tbVer, vulnerable_range:"10.0 - 10.0.4");
    security_message(port: 0, data: report);
    exit(0);
  }
}
