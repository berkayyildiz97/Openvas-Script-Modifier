...
if(description)
{
  ...
  script_version("2019-12-13T13:10:50+0000");
  script_cve_id("CVE-2010-1194", "CVE-2010-1192");
  script_tag(name:"last_modification", value:"2019-12-13 13:10:50 +0000 (Fri, 13 Dec 2019)");
...
if(version_is_less_equal(version:version, test_version:"1.0.4")) {
  ...
  report = report_fixed_ver(installed_version:version, vulnerable_range:"Less than or equal to 1.0.4");
