...
if(description)
{
  ...
  script_version("2019-12-17T13:59:26+0000");
  script_tag(name:"last_modification", value:"2019-12-17 13:59:26 +0000 (Tue, 17 Dec 2019)");
...
foreach path (make_list_unique("/", "/F3Site/SYSTEM", "/F3Site", cgi_dirs(port:port))) {
