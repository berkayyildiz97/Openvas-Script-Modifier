   ...
   if("Service Pack 4" >< SP) {
    ...
    if (is_vuln1) {
       if(version_in_range(version:vers, test_version:"5.0", test_version2:"5.0.3849.499")) {
          report = report_fixed_ver(installed_version:vers, fixed_version:"5.0.3849.500", install_path:dllPath);
       ...
       if(version_in_range(version:vers, test_version:"6.0", test_version2:"6.0.2800.1588")) {
          report = report_fixed_ver(installed_version:vers, fixed_version:"5.0.3849.5006.0.2800.1589", install_path:dllPath);
          security_message(data:report);
       }
       exit (0);
    }
   ...
   if("Service Pack 2" >< SP) {
    ...
    if (is_vuln1) {
       if(version_in_range(version:vers, test_version:"6.0", test_version2:"6.0.2900.3058")) {
          report = report_fixed_ver(installed_version:vers, fixed_version:"5.0.3849.5006.0.2800.15896.0.2900.3059", install_path:dllPath);
          security_message(data:report);
       }
       exit (0);
    }
       ...
       if(version_in_range(version:vers, test_version:"7.0", test_version2:"7.0.6000.16413")) {
          report = report_fixed_ver(installed_version:vers, fixed_version:"5.0.3849.5006.0.2800.15896.0.2900.30597.0.6000.16414", install_path:dllPath);
          security_message(data:report);
       }
       exit (0);
    }
    ...
    if (is_vuln1) {
       if(version_in_range(version:vers, test_version:"7.0", test_version2:"7.0.6000.16413")) {
          report = report_fixed_ver(installed_version:vers, fixed_version:"5.0.3849.5006.0.2800.15896.0.2900.30597.0.6000.164147.0.6000.16414", install_path:dllPath);
          security_message(data:report);
       }
       exit (0);
    }
       ...
       if(version_in_range(version:vers, test_version:"6.0", test_version2:"6.0.3790.629")) {
          report = report_fixed_ver(installed_version:vers, fixed_version:"5.0.3849.5006.0.2800.15896.0.2900.30597.0.6000.164147.0.6000.164146.0.3790.630", install_path:dllPath);
          security_message(data:report);
       }
       exit (0);
    }
