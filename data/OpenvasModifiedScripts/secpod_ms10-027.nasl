...
if(hotfix_check_sp(win2k:5) > 0)
{
  if(version_in_range(version:windowsMediaPlayerVer, test_version:"9",
    ...
    report = report_fixed_ver(installed_version:windowsMediaPlayerVer, fixed_version:"9.0.0.3366");
...
if(hotfix_check_sp(xp:4) > 0)
{
  ...
  else if("Service Pack 3" >< SP)
  {
    if(version_in_range(version:windowsMediaPlayerVer, test_version:"9",
      ...
      report = report_fixed_ver(installed_version:windowsMediaPlayerVer, fixed_version:"9.0.0.4507");
      security_message(data:report);
    }
    exit(0);
  }
