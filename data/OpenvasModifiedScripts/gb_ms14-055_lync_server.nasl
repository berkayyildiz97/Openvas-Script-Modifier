...
if("Microsoft Lync Server 2010" >< ms_lync_name)
{
  ...
  if(ms_lync_path)
  {
    ...
    if(wrtces_ver)
    {
      ...
      {
        report = report_fixed_ver(installed_version:wrtces_ver, fixed_version:"4.0.7577.230", install_path:ms_lync_path);
    ...
    if(workflow_ver)
    {
      ...
      {
        report = report_fixed_ver(installed_version:workflow_ver, fixed_version:"4.0.7577.2304.0.7577.276", install_path:ms_lync_path);
        security_message(data:report);
        exit(0);
      }
    }
...
if("Microsoft Lync Server 2013" >< ms_lync_name)
{
  ...
  if(ms_lync_path)
  {
    ...
    if(sip_ver)
    {
      ...
      {
        report = report_fixed_ver(installed_version:sip_ver, fixed_version:"4.0.7577.2304.0.7577.2765.0.8308.803", install_path:ms_lync_path);
        security_message(data:report);
        exit(0);
      }
    }
    ...
    if(workflow_ver)
    {
      ...
      {
        report = report_fixed_ver(installed_version:workflow_ver, fixed_version:"4.0.7577.2304.0.7577.2765.0.8308.8035.0.8308.803", install_path:ms_lync_path);
        security_message(data:report);
        exit(0);
      }
    }
    ...
    if(resources_ver)
    {
      ...
      {
        report = report_fixed_ver(installed_version:resources_ver, fixed_version:"4.0.7577.2304.0.7577.2765.0.8308.8035.0.8308.8035.0.8308.420", install_path:ms_lync_path);
        security_message(data:report);
        exit(0);
      }
    }
    ...
    if(autodiscover_ver)
    {
      ...
      {
        report = report_fixed_ver(installed_version:autodiscover_ver, fixed_version:"4.0.7577.2304.0.7577.2765.0.8308.8035.0.8308.8035.0.8308.4205.0.8308.726", install_path:ms_lync_path);
        security_message(data:report);
        exit(0);
      }
    }
