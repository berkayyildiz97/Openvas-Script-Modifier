...
if(hotfix_check_sp(win2k:5) > 0)
{
  if(version_in_range(version:httpVer, test_version:"5.0",
    ...
    report = report_fixed_ver(installed_version:httpVer, fixed_version:"5.0.2195.7289");
...
else if(hotfix_check_sp(win2003:3) > 0)
{
  ...
  if("Service Pack 2" >< SP)
  {
    if(version_in_range(version:httpVer, test_version:"6.0",
      ...
      report = report_fixed_ver(installed_version:httpVer, fixed_version:"6.0.3790.4517");
      security_message(data:report);
    }
  }
...
else if(hotfix_check_sp(xp:4) > 0)
{
  ...
  if("Service Pack 2" >< SP)
  {
    if(version_in_range(version:httpVer, test_version:"6.0",
      ...
      report = report_fixed_ver(installed_version:httpVer, fixed_version:"6.0.2600.3573");
      security_message(data:report);
    }
  }
  else if("Service Pack 3" >< SP)
  {
    if(version_in_range(version:httpVer, test_version:"6.0",
      ...
      report = report_fixed_ver(installed_version:httpVer, fixed_version:"6.0.2600.5816");
      security_message(data:report);
    }
  }
  security_message( port: 0, data: "The target host was found to be vulnerable" );
