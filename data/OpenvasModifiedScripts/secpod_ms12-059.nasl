...
if(sysPath)
{
  ...
  if(exeVer)
  {
    ...
    {
      report = report_fixed_ver(installed_version:exeVer, fixed_version:"14.0.6122.5000");
...
if(vvVer && vvVer =~ "^14\..*")
{
  if(version_in_range(version:vvVer, test_version:"14.0", test_version2:"14.0.6116.4999")){
    report = report_fixed_ver(installed_version:vvVer, fixed_version:"14.0.6122.500014.0.6116.5000");
    security_message(data:report);
  }
}
