...
if(vmplayerVer)
{
  if(version_is_less_equal(version:vmplayerVer, test_version:"1.0.8"))
  {
    ...
    exit(0);
          ...
          test_version2:"2.0.5")){
    report = report_fixed_ver(installed_version:vmplayerVer, fixed_version:"2.0.5");
...
if(vmworkstnVer)
{
  if(version_in_range(version:vmworkstnVer, test_version:"5.0",
                      test_version2:"5.5.8"))
  {
    report = report_fixed_ver(installed_version:vmworkstnVer, fixed_version:"5.5.8");
    security_message(data:report);
    exit(0);
  }
  else if(version_in_range(version:vmworkstnVer, test_version:"6.0",
          test_version2:"6.0.5")){
    report = report_fixed_ver(installed_version:vmworkstnVer, fixed_version:"6.0.5");
    security_message(data:report);
  }
  exit(0);
}
...
if(vmaceVer)
{
  if(version_is_less_equal(version:vmaceVer, test_version:"1.0.7"))
  {
    ...
    exit(0);
          ...
          test_version2:"2.0.5")){
    report = report_fixed_ver(installed_version:vmaceVer, fixed_version:"2.0.5");
    security_message(data:report);
  }
}
