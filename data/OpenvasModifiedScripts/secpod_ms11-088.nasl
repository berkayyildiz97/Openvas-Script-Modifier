  ...
  if(egrep(pattern:"Microsoft Office IME .*Chinese", string:imeName))
  {
    ...
    if(path)
    {
      ...
      if(dllVer)
      {
        ...
        {
          report = report_fixed_ver(installed_version:dllVer, fixed_version:"14.0.6019.1000", install_path:imePath);
  ...
  if(egrep(pattern:"Microsoft Office IMESS .*Chinese", string:MSOffName))
  {
    ...
    if(path)
    {
      ...
      if(dllVer)
      {
        ...
        {
          report = report_fixed_ver(installed_version:dllVer, fixed_version:"14.0.6019.100014.0.5810.1000", install_path:imePath);
          security_message(data:report);
          exit(0);
        }
      }
