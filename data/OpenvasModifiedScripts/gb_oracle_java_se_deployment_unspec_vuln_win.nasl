...
if(jreVer)
{
  ...
  {
    report = report_fixed_ver(installed_version:jreVer, fixed_version:"1.6.0.28");
...
if(jdkVer)
{
  if(version_in_range(version:jdkVer, test_version:"1.6", test_version2:"1.6.0.27")) {
    report = report_fixed_ver(installed_version:jdkVer, fixed_version:"1.6.0.281.6.0.28");
    security_message(data:report);
  }
}
