...
if(jdkVer)
{
  ...
  {
    report = report_fixed_ver(installed_version:jdkVer, fixed_version:"1.5.0.20");
...
if(jreVer)
{
  if(version_in_range(version:jreVer, test_version:"1.5", test_version2:"1.5.0.19")){
    report = report_fixed_ver(installed_version:jreVer, fixed_version:"1.5.0.201.5.0.20");
    security_message(data:report);
    exit(0);
  }
}
