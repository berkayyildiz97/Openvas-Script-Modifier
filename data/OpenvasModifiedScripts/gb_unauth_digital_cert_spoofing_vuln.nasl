...
if(hotfix_check_sp(xp:4) > 0)
{
  if(version_is_less(version:dllVer, test_version:"5.131.2600.6237")){
    report = report_fixed_ver(installed_version:dllVer, fixed_version:"5.131.2600.6237", install_path:sysPath);
...
else if(hotfix_check_sp(win2003:3, win2003x64:3, xpx64:3) > 0)
{
  if(version_is_less(version:dllVer, test_version:"5.131.3790.5012")){
    report = report_fixed_ver(installed_version:dllVer, fixed_version:"5.131.3790.5012", install_path:sysPath);
    security_message(data:report);
  }
  exit(0);
}
