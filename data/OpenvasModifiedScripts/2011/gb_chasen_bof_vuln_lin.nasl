...
if(description)
{
  ...
  script_version("2019-12-13T07:19:56+0000");
  script_cve_id("CVE-2011-4000");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2019-12-13 07:19:56 +0000 (Fri, 13 Dec 2019)");
...
foreach binaryName(chaName) {
  ...
  chaVer = get_bin_version(full_prog_name:binaryName, version_argv:"--version",
                           ver_pattern:"[0-9.]{5,}", sock:sock);
